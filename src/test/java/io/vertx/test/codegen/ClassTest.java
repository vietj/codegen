...
public class ClassTest extends ClassTestBase {
  ...
  public void testValidDataObjectsParam() throws Exception {
    ClassModel model = new GeneratorHelper()
      .registerSerializer(URI.class, MethodWithDataObjectParam.class.getName(), "deserializeURI")
  ...
  public void testValidDataObjectReturn() throws Exception {
    ClassModel model = new GeneratorHelper()
      .registerSerializer(URI.class, MethodWithValidDataObjectReturn.class.getName(), "serializeURI")
  ...
  public void testJsonMapper() throws Exception {
    ClassModel model = new GeneratorHelper()
      .registerSerializer(MyPojo.class, WithMyPojo.class.getName(), "serializeMyPojo")
      .registerSerializer(MyPojo.class, WithMyPojo.class.getName(), "deserializeMyPojo")
